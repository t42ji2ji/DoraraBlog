...
![Overseas competition subsidy program](https://i.imgur.com/LfD9pHk.jpeg)
...
**題目：**
透過 zk Proof 證明自己已經在 web2 的網站上入金。在合約上去驗證這些 proof，就可以自動發放 token 給使用者。這個概念在 DeFi 上有很大的應用空間，我們也在這次的黑客松上得到 🦊 Metamask 的項目方認可，認為這個概念是可以實現的。

由於要製作比賽的簡報，我自己也在這次的比賽中，對於 OTC 這件事情為什麼很重要有了新的理解。OTC 或者說 P2P 交易本質上可以看成是更加純粹的價值交換，因為這種交易方式不需要經過中間商，所以可以減少價值的流失以及交易的成本。在還沒萬物都 Tokenize 的時代之前，OTC 交易可能是一個解決方案。
