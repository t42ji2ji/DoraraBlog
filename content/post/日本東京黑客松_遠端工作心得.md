...
由於要製作比賽的簡報，我自���也在這次的比賽中，對於 OTC 這件事情為什麼很重要有了新的理解。OTC 或者說 P2P 交易本質上可以看成是更加純粹的價值交換，因為這種交易方式不需要經過中間商，所以可以減少價值的流失以及交易的成本。在還沒萬物都 Tokenize 的時代之前，OTC 交易可能是一個解決方案。
